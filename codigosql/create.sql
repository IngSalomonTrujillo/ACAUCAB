...
CREATE TABLE Evento 
    ( 
     ...
     entradas_disponibles       INTEGER  NOT NULL DEFAULT 0
    ) 
;
...
-- Tabla intermedia para asignar proveedores a eventos
...
-- Tabla intermedia para asignar cervezas a proveedores en eventos
CREATE TABLE Evento_Proveedor_Cerveza (
  evento_id INTEGER NOT NULL,
  proveedor_id INTEGER NOT NULL,
  cerveza_id INTEGER NOT NULL,
  PRIMARY KEY (evento_id, proveedor_id, cerveza_id),
  FOREIGN KEY (evento_id, proveedor_id) REFERENCES Evento_Proveedor(evento_id, proveedor_id),
  FOREIGN KEY (cerveza_id) REFERENCES Cerveza(cerveza_id)
);

-- Tabla intermedia para relación N a N entre Inventario y Orden_Reposición
CREATE TABLE Inventario_Orden_Reposicion (
    inventario_id INTEGER NOT NULL,
    orden_reposición_id INTEGER NOT NULL,
    tienda_fisica_id INTEGER NOT NULL,
    cerveza_id INTEGER NOT NULL,
    presentacion_id INTEGER NOT NULL,
    cantidad INTEGER NOT NULL DEFAULT 0,
    PRIMARY KEY (inventario_id, orden_reposición_id, cerveza_id, presentacion_id),
    FOREIGN KEY (inventario_id) REFERENCES Inventario(inventario_id),
    FOREIGN KEY (orden_reposición_id) REFERENCES Orden_Reposición(orden_reposición_id),
    FOREIGN KEY (tienda_fisica_id) REFERENCES Tienda_Física(tienda_fisica_id),
    FOREIGN KEY (cerveza_id) REFERENCES Cerveza(cerveza_id),
    FOREIGN KEY (presentacion_id) REFERENCES Presentación(presentación_id)
);
